<div class="tipologias view">
<h2><?php  __('Tipologia');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipologia['Tipologia']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Segmento Cultural'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipologia['Tipologia']['segmento_cultural']; ?>
			&nbsp;
		</dd>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Tempo Atuação'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipologia['Tipologia']['tempo_atuacao']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<h3><?php __('Ações'); ?></h3>
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Editar %s', true), __('Tipologia', true)), array('action' => 'edit', $tipologia['Tipologia']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Excluir %s', true), __('Tipologia', true)), array('action' => 'delete', $tipologia['Tipologia']['id']), null, sprintf(__('Você tem certeza que deseja excluir o id #%s?', true), $tipologia['Tipologia']['id'])); ?> </li>
