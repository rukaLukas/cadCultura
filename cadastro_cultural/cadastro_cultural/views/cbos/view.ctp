...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Cbo', true), array('action' => 'edit', $cbo['Cbo']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Cbo', true), array('action' => 'delete', $cbo['Cbo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $cbo['Cbo']['id'])); ?> </li>
