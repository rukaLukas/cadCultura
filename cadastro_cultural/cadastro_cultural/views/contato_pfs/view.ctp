...
<h2><?php  __('Contato Pf');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Telefone Pf'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	...
	<tr>
		...
		<th><?php __('Contato Pf Id'); ?></th>
		<th class="actions"><?php __('Ações');?></th>
	</tr>
	<?php
		$i = 0;
		foreach ($contatoPf['Pf'] as $pf):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $pf['contato_pf_id'];?></td>
			<td class="actions">
