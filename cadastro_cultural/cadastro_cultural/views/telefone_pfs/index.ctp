<div class="telefonePfs index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $telefonePf['TelefonePf']['id'])); ?>
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $telefonePf['TelefonePf']['id'])); ?>
			<?php echo $this->Html->link(__('Excluir', true), array('action' => 'delete', $telefonePf['TelefonePf']['id']), null, sprintf(__('Você tem certeza que deseja excluir o id #%s?', true), $telefonePf['TelefonePf']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
