...
$.extend($.validator, {
	...
	messages: {
		required: "Informe um valor para esse campo.",
		...
		maxlength: $.format("Favor, não informe mais que {0} caracteres."),
		minlength: $.format("Favor, não informe menos que {0} caracteres."),
		rangelength: $.format("Favor, informe um valor entre {0} e {1} caracteres."),
		range: $.format("Favor, informe um valor entre {0} e {1}."),
		max: $.format("Favor, informe um valor menor ou igual a: {0}."),
		min: $.format("Favor, informe um valor maior oiu igual a: {0}.")
	},
