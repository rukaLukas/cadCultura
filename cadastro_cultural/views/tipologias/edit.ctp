...
<?php echo $this->Form->create('Tipologia');?>
	<fieldset>
 		<legend><?php printf(__('Editar %s', true), __('Tipologia', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Excluir', true), array('action' => 'delete', $this->Form->value('Tipologia.id')), null, sprintf(__('Você tem certeza que deseja excluir o id #%s?', true), $this->Form->value('Tipologia.id'))); ?></li>
