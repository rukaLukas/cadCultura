...
<?php    echo $form->create('Portifolio');?>
    	<fieldset>
		<legend><?php __('Adicionar Portifolio'); ?></legend>
...
<div class="cont_4"><br style="clear:both" />
    ...
    <input type="button" class="botaoAba" onclick="salvarItem('false','#PortifolioAddForm','portifolios','#portifolio','#portifolios');" value="Salvar"/>
</div>
</div>
