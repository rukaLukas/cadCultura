...
<?php    echo $form->create('Dirigente',array('id'=>'DirigenteAddForm'));?>
    	<fieldset>
		<legend><?php __('Editar Outro Dirigente'); ?></legend>


    <?php echo $form->input('index', array('type'=>'hidden','name'=> 'data[Dir][index]',"value"=> $this->data["Dir"]["index"]));?>
...
<div class="cont_4">
    ...
    <input type="button" class="botaoAba" onclick="salvarItem('true','#DirigenteAddForm','dirigentes','#dirigente','#dirigentes');" value="Salvar"/>
