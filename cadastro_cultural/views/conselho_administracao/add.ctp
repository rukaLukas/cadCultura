...
<?php    echo $form->create('ConselhoAdministracao');?>
    	<fieldset>
		<legend><?php __('Adicionar Conselho Administração'); ?></legend>
...
<div class="cont_4"><br style="clear:both" />
    ...
    <input type="button" class="botaoAba" onclick="salvarItem('false','#ConselhoAdministracaoAddForm','conselhos_administracao','#conselhoAdministracao','#conselhosAdministracao');" value="Salvar"/>
</div>
</div>
