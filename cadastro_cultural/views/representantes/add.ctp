...
<?php    echo $form->create('Representante');?>
    	<fieldset>
		<legend><?php __('Adicionar Representante Legal'); ?></legend>
<?php
...
<div class="submit">
    <div class="submit">
    <input type="button" onclick="salvarItem('false','#RepresentanteAddForm','representantes','#representante','#representantes');" value="Salvar"/>
</div>
</div>
