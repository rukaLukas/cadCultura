<div class="cidades index">
	...
	<tr<?php echo $class;?>>		
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Excluir', true), array('action' => 'delete', $cidade['Cidade']['id']), null, sprintf(__('Você tem certeza que deseja excluir o id #%s?', true), $cidade['Cidade']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
