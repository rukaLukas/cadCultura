...
<?php    echo $form->create('ConselhoFiscal');?>
    	<fieldset>
		<legend><?php __('Adicionar Conselho Fiscal'); ?></legend>
...
<div class="cont_4"><br style="clear:both" />
    ...
    <input type="button" class="botaoAba" onclick="salvarItem('false','#ConselhoFiscalAddForm','conselhos_fiscais','#conselhoFiscal','#conselhosFiscais');" value="Salvar"/>
    </div>
</div>
