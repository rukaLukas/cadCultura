...
<h2><?php  __('Nacionalidade');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $nacionalidade['Nacionalidade']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Descrição'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $nacionalidade['Nacionalidade']['descricao']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $nacionalidade['Nacionalidade']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $nacionalidade['Nacionalidade']['modified']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<h3><?php __('Ações'); ?></h3>
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Editar %s', true), __('Nacionalidade', true)), array('action' => 'edit', $nacionalidade['Nacionalidade']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Excluir %s', true), __('Nacionalidade', true)), array('action' => 'delete', $nacionalidade['Nacionalidade']['id']), null, sprintf(__('Você tem certeza que deseja excluir o id #%s?', true), $nacionalidade['Nacionalidade']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($nacionalidade['Pf'] as $pf):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
